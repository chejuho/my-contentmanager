						...
						<table width="340" height="310" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td height="162" align="center">
									...
									<tr>
										<td width="40%" height="29" align="left"><strong>ID</strong></td>
										<td width="60%" align="left">
											...
											<input type="text" name="id"  style="width:150;height:20" size="20"  tabindex="1" />

										</td>
									</tr>
									<tr>
										<td align="left"><strong>パスワード</strong></td>
										<td align="left">
											<input type="password" name="password"  style="width:150;height:20" size="20"  tabindex="2" />
										</td>
									</tr>
									<tr>
										<td colspan ="2">&nbsp;</td>
