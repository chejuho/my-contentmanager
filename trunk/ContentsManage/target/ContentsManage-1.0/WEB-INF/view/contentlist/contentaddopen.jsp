...
<tiles:insert template="/WEB-INF/view/common/layout.jsp" flush="true">
	<tiles:put name="title" value="テーブル追加" />
	...
	<tiles:put name="content" type="string">
		...
		<s:form action="contentAdd" enctype="multipart/form-data">
			<input type="hidden"  name = "editContentId"  value="${editContentId}" />
			<input type="hidden" name="contentsname" value="${contentsname}"   style="width:240px;" />
			<table class="basic" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan="2" align="center">
							<input type="submit" name="add" value="追加" style="font-size=20px;" />
